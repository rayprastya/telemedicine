...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference("Doctor.count") do
      post doctors_url, params: { doctor: { experience: @doctor.experience, user_id: @doctor.user_id } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { experience: @doctor.experience, user_id: @doctor.user_id } }
